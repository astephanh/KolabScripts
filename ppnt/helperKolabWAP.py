...
class KolabWAPTestHelpers(unittest.TestCase):
    ...
    def init_driver(self):
        ...
        self.driver = webdriver.PhantomJS('phantomjs', port=50000, service_args=['--ignore-ssl-errors=true', '--ssl-protocol=tlsv1', '--webdriver-loglevel'])
    ...
    def create_domain(self, name = None, domainadmin = None, withAliasDomain = False):
	...
	for folder in folders:
		if username in imap_utf7.decode(folder) and domain in imap_utf7.decode(folder):
			return True
	return False
