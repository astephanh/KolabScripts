...
# Domain Deleting
[ -d /usr/share/kolab-webadmin/bin ]  || mkdir -p /usr/share/kolab-webadmin/bin
cp -a `pwd`/domain_delete.php	/usr/share/kolab-webadmin/bin 
echo '0 */2 * * * root /usr/bin/php /usr/share/kolab-webadmin/bin/domain_delete.php > /var/log/kolab/domain_delete.log' > /etc/cron.d/kolab
